...
- 🎓 **2025 Graduate** in Computer Applications (BCA).
- 🔭 I specialize in **AI-Integrated Web Apps**, blending robust backends with immersive frontends.
- 🌱 Currently exploring **Agentic workflows** and **Serverless advancements**.
- 💡 I love building tools that solve real-world problems—from **real-time voice interviewers** to **AI fashion assistants**.
- 📫 Reach me at: **adityanarayanraikoti@gmail.com**
...
| :--- | :--- | :--- |
| **🎙️ Next Hire** | A **real-time voice interview platform** with sub-500ms latency. Features a custom turn-taking algorithm and eliminates middleware costs completely. | Next.js, Deepgram, Gemini 2.5 Flash, GCP |
| **👗 FitCheck AI** | An **AI fashion assistant** with Virtual Try-On and Style Analysis. Includes a "Zinc & Lime" styling system and smart gallery. | Next.js, Tailwind, Firebase, Gemini 1.5 |
| **✈️ TripoAI** | Intelligent **travel planner** generating context-aware itineraries in <3s. Features reactive backend sync and dynamic multimedia galleries. | Next.js 15, Convex, Clerk, Gemini 1.5 |

> *Check out all my projects at my [Portfolio](https://portfolio.aditya-dev.works)*
...
<p align="center">
  <a href="https://linkedin.com/in/adityadev26" target="blank">
